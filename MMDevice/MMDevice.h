   ...
   */
   ...
   public:
       ...
       */
       ...
       /**
       * Dispenses until volume is zero, or stopped
       */
       ...
       */
       ...
       /**
       * Calibrates the pressure controller. Might not be supported, if so
       * either return DEVICE_UNSUPPORTED_COMMAND, or DEVICE_OK, depending
