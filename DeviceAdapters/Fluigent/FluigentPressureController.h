...
public:
    ...
    * @returns MMDeviceConstants ErrorCode
    */
    int GetPressureLimits(float& Pmin, float& Pmax);
...
public:
    ...
    float Pmin_ = 0; // Minimum pressure
    float Pmax_ = 0; // Maximum pressure
    float Pimp_ = 0; // Imposed pressure
    float Pmeas_= 0; // Measured pressure
